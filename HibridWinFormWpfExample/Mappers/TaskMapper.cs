...
namespace HibridWinFormWpfExample.Mappers
{
    public static class TaskMapper
    {
        ...
        {
            return new TaskEntity {CreateDate = model.CreateDate, DueDate = model.DueDate, CompletionDate = model.CompletionDate, TaskTitle = model.TaskTitle, TaskDiscription = model.TaskDiscription };
        }        
